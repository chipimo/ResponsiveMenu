...
class SignUp extends React.Component {
  ...
  validatePhone = number => {
    ...
    if (!sub.match(numbers)) {
      this.setState({
        nameErrorMsg: "Invalid phone number",
        errors: {
          ...this.state.errors,
          phone: false
        }
      ...
      this.setState({
        nameErrorMsg: "Invalid phone number 2",
        errors: {
          ...this.state.errors,
          phone: false
        }
  ...
  onSignUpButtonPressed = () => {
    if (!this.state.userTemp.name) {
      ...
      var dataFiles = {
        ...
        password: this.state.userTemp.password,
        isSingedin: false,
        img: ""
      };
      this.props.SocketConfig.socket.emit("USER_REGSTRATION", dataFiles);
            ...
            data.setTempData("userTemp", "isRegistered", responce => {
              if (responce) {
                ...
                const toHome = StackActions.reset({
                  index: 0,
                  actions: [NavigationActions.navigate({ routeName: "UserId" })]
                });
            ...
            >
              <View
                style={[
                  ...
                  {
                    marginBottom: 10,
                    borderColor: this.state.errors.name
